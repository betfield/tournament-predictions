                ...
                <div className="hpanel">
                    <div className="panel-body login-panel">
                        <div className="col-md-4 text-left">
                            ...
                            <ul>
                                <li>
                                    Esimese sammuna pead end süsteemi kasutajaks lisama, mis toimub automaatselt, kui logid sisse oma Google konto kaudu.
                                </li>
                                <li>
                            ...
                            <ul>
                                <li>
                                    Mängus saavad kaasa lüüa kõik jalgpallisõbrad, kellel vanust üle 21 eluaasta ning olemas kehtiv Google konto.
                                </li>
                                <li>
                        ...
                        <div className="col-md-4 text-left">
                            ...
                            <ul>
                                ...
                                <li>
                                    Kui juhtub, et mitmel kasutajal on sama punktide summa, siis otsustatakse lõplik järjestus allolevate reeglite järgi:
                                    <ul>
