                    ...
                    <div className="row">
                        <div className="col-lg-4 col-lg-offset-2">
                            <ul>
                                ...
                                <li>
                                    Ennustus on jagatud kaheksaks (8) vooruks, vastavalt sellele kui palju mänge peab üks meeskond läbima, et tulla maailmameistriks.
                                </li>
                                <li>
                        ...
                        <div className="col-lg-4">
                            <ul>
                                ...
                                <li>
                                    Veerand- ja poolfinaalide tulemused on võimendatud 2x, finaalide tulemused 3x.
                                </li>
                                <li>
